          ...
          <div>
            ...
            <Link href="/">
              <div className="flex items-center gap-2">
                ...
                text-xs text-gray-500 hidden xl:block"
                >
                  {post.postedBy.userName}
                </p>
              </div>
      ...
      <div className="lg:ml-20 flex gap-4 relative">
        ...
        >
          <Link href="/">
            ...
            md:h-[400px] lg:h-[530px] w-[200px] rounded-2xl
          ...
          {isHover && (
            ...
            left-8 md:left-14 lg:left-0 flex gap-10
            lg:justify-between w-[100px] md:w-[50px] p-3"
            >
              {playing ? (
